...
public class LootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(BlockInit.WISTERIA_LEAVES, oakLeavesDrops(BlockInit.WISTERIA_LEAVES, BlockInit.WISTERIA_SAPLING, 0.2f));
        ...
        addDrop(BlockInit.WISTERIA_LEAVES);
        ...
        addDrop(BlockInit.CHARRED_STAIRS);
        addDrop(BlockInit.WISTERIA_SLAB, slabDrops(BlockInit.WISTERIA_SLAB));
        addDrop(BlockInit.WISTERIA_FENCE);
        addDrop(BlockInit.WISTERIA_FENCE_GATE);
        addDrop(BlockInit.WISTERIA_DOOR, doorDrops(BlockInit.WISTERIA_DOOR));
        addDrop(BlockInit.WISTERIA_TRAPDOOR);
        addDrop(BlockInit.WISTERIA_PRESSURE_PLATE);
        addDrop(BlockInit.WISTERIA_BUTTON);
        addDrop(BlockInit.WISTERIA_WOOD);
        addDrop(BlockInit.WISTERIA_LOG);
        addDrop(BlockInit.WISTERIA_PLANKS);
        addDrop(BlockInit.STRIPPED_WISTERIA_WOOD);
        addDrop(BlockInit.STRIPPED_WISTERIA_LOG);
