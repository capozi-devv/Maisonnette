...
public class LootTableProvider extends FabricBlockLootTableProvider {
    ...
    List<Float> yellowWillowList = List.of(0.05F, 0.055555557F, 0.0625F, 0.08333334F, 0.025F);
    public LootTable.Builder yellowWillowLeavesDrops(Block leaves, Block sapling, float... saplingChance) {
