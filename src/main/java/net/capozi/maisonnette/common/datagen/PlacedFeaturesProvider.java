...
public class PlacedFeaturesProvider {
    ...
    public static void boostrap(Registerable<PlacedFeature> context) {
        ...
        register(context, WILLOW_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ConfiguredFeaturesProvider.WILLOW_KEY), VegetationPlacedFeatures.treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(2, 0.1f, 2), BlockInit.RED_WILLOW_SAPLING));
    }
}
