...
public class ExpandedJigsawStructure extends Structure {
    public static final int MAX_SIZE = 128;
    public static final Codec<net.minecraft.world.gen.structure.JigsawStructure> CODEC = Codecs.validate(RecordCodecBuilder.mapCodec((instance) -> instance.group(configCodecBuilder(instance), StructurePool.REGISTRY_CODEC.fieldOf("start_pool").forGetter((structure) -> structure.startPool), Identifier.CODEC.optionalFieldOf("start_jigsaw_name").forGetter((structure) -> structure.startJigsawName), Codec.intRange(0, 7).fieldOf("size").forGetter((structure) -> structure.size), HeightProvider.CODEC.fieldOf("start_height").forGetter((structure) -> structure.startHeight), Codec.BOOL.fieldOf("use_expansion_hack").forGetter((structure) -> structure.useExpansionHack), Heightmap.Type.CODEC.optionalFieldOf("project_start_to_heightmap").forGetter((structure) -> structure.projectStartToHeightmap), Codec.intRange(1, 128).fieldOf("max_distance_from_center").forGetter((structure) -> structure.maxDistanceFromCenter)).apply(instance, net.minecraft.world.gen.structure.JigsawStructure::new)), net.minecraft.world.gen.structure.JigsawStructure::validate).codec();
    ...
    private static DataResult<net.minecraft.world.gen.structure.JigsawStructure> validate(net.minecraft.world.gen.structure.JigsawStructure structure) {
        byte var10000;
